    ...
    <div class="flex flex-1 items-center justify-end md:justify-between">
      <nav aria-label="Global" class="hidden md:block">
        <ul class="flex items-center gap-6 text-sm">
          ...
          <li>
            <a class="text-gray-500 {{Request::is('about') ? 'text-gray-700 font-bold' : ''}} transition hover:text-gray-500/75" wire:navigate href="#"> About </a>
          </li>
      ...
      <div class="flex items-center gap-4">
        <div class=" sm:flex   sm:gap-4">
          ...
          @else
          <a
            class="block rounded-md bg-red-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-blue-700"
            href="/auth/login">
            Get Started
          </a>
          @endif
